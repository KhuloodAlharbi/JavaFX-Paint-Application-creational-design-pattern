...
public abstract class Shape implements iShape,Prototype{
...
public Shape clone() {
    try {
        // نسخ سطحية (shallow copy)
        return (Shape) super.clone();
    } catch (CloneNotSupportedException e) {
        throw new AssertionError(); // ما يصير لأنه implements Cloneable
    }
}

// واجهة Prototype تستعمل clone()
@Override
